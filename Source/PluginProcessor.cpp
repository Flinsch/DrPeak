...
//==============================================================================
DrPeakAudioProcessor::DrPeakAudioProcessor()
...
//==============================================================================
const juce::String DrPeakAudioProcessor::getName() const
{
    return JucePlugin_Name;
}

bool DrPeakAudioProcessor::acceptsMidi() const
{
...
bool DrPeakAudioProcessor::producesMidi() const
{
...
bool DrPeakAudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
double DrPeakAudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}

int DrPeakAudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int DrPeakAudioProcessor::getCurrentProgram()
{
    return 0;
}
...
//==============================================================================
bool DrPeakAudioProcessor::hasEditor() const
{
...
{
    return new DrPeakAudioProcessor();
}
